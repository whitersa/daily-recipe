      ...
      <main className="flex-1 overflow-y-auto no-scrollbar px-8 py-10 space-y-10">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-4">
             ...
             <h2 className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#8E8C87]">Specifications</h2>
          </div>
          <div className="flex flex-col gap-2">
            <label className="text-[9px] font-bold uppercase tracking-widest text-[#8E8C87] ml-1">Duration</label>
            <input 
              type="text" 
